...
let countdownBeep = new Audio(`/static/stats/sounds/beep_countdown.mp3`);
let countdownGo = new Audio(`/static/stats/sounds/go_countdown.mp3`);
let pingSound = new Audio(`/static/stats/sounds/ping.mp3`);
let pongSound = new Audio(`/static/stats/sounds/pong.mp3`);
let pointSound = new Audio(`/static/stats/sounds/point.mp3`);
let winSound = new Audio(`/static/stats/sounds/win.mp3`);

const statsName = JSON.parse(document.getElementById('stats_name').textContent);
const socket = new WebSocket(
	'wss://' + window.location.host + '/ws/stats/' + statsName + '/'
);
